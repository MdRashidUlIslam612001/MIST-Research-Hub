  ...
  <body>
    ...
    <!-- navbar ends -->
        ...
        <div class="signup-form">
                ...
                <p class="hint-text">Enter your account_id and password bellow:</p>
                <div class="social-btn text-center">
                    ...
                    <br>
                    <br>
                    <a type="button" class="btn btn-info" href="signup.html">Don't have an account? Click here to Signup!</a>
                </div>
                <br> 
                <br>
        </div>
