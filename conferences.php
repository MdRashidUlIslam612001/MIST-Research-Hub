         ...
         - LEFT BAR ends -->
          ...
          <div class="col-xxl-9 col-12">-->
            <div class="card mb-2 border border-3  border-success">
              <h5 class="card-header text-white bg-success">Conferences</h5>



              <?php
                                $sql = "select * from CONFERENCE WHERE START_DATE > SYSDATE ORDER BY START_DATE ASC ";
                              ...
                              <div class="card-body bg-white">
                                <a
                                  ...
                                  <span>Venue: '. $row['VENUE'] .' </span>
                                    ...
                                    <p class="m-0 p-2">
                                    <h6 class="d-inline-block"> Submission Date:   </h6> <span>' .$row['SUBMISSION_DATE'] . ' </span>
                                       <br>
                                        <h6 class="d-inline-block"> Starts on:  </h6> <span>' .$row['START_DATE']. '</span> <br>
                                        <h6 class="d-inline-block"> Ends on:  </h6> <span>' .$row['END_DATE'] . '</span>
