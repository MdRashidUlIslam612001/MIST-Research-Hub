...
session_start();
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    if(isset($_POST['submit'])) {
      ...
      VALUES ('F_' || per_user_sq.NEXTVAL,'$name','$phone','$email','$password','$dept','$res_int','$no_of_researches','$no_of_attended_conferences')";
      $stid = oci_parse($conn, $sql);
      $r = oci_execute($stid);

      $sql = "
      insert into FACULTY (FACULTY_ID ,ACC_ID,INSTITUTION ,DESIGNATION,QUALIFICATION )
      VALUES ('$id','F_' || per_user_sq.CURRVAL,'$institution',' $designation ','$qualification')";
      $stid = oci_parse($conn, $sql);
      $r = oci_execute($stid);
    }
  }
...
<div class="bg-light" >
  <div class="container" style="padding: 10px 10px 0px 0px;">
    <h2 style="text-align: left"><b>Faculty Registration Form:</b></h2>
  </div> 
  ...
  <form class="row g-3 bg-white border p-3 border-1" style="border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" action="" method="POST">
      ...
      <div class="col-md-12">
        ...
        <input type="text" required class="form-control" name="FacultyName" id="FacultyName" />
      </div>
      
      <div class="col-md-6">
        <label for="FacultyID" class="form-label">
        <h6>Faculty ID<font color="ff0000">*</font></h6>
        </label>
        <input type="text" required class="form-control" name="FacultyID" id="FacultyID" maxlength="9" minlength="5"/>
      </div>
      ...
      <div class="col-md-6">
        <label for="Faculty Photo" class="form-label">
        <h6>Your Photo</h6>
        </label>
        <br />
      ...
      <div class="col-md-6">
        ...
        </label><input type="number" id="no_of_attended_conferences" name="no_of_attended_conferences" min="1" max="100">
        <br/>
    ...
    <!--  <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <h6>Institution<font color="ff0000">*</font></h6>
        </label>
        <input type="text" required class="form-control" id="Institution" name="Institution"  />
      </div>
      <div class="col-md-12">
        <label for="Designation" class="form-label">
        <h6>Designation<font color="ff0000">*</font></h6>
        </label>
        <input type="text" required class="form-control" id="Designation" name="Designation"  />
      </div>
      <div class="col-md-12">
        <label for="Qualification" class="form-label">
        <h6>Qualification<font color="ff0000">*</font></h6>
        </label>
